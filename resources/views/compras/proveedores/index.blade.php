...
<div class=" card shadow mb-4">
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" id="mediumButton" data-target="#mediumModal" data-attr="proveedores/create" title="Crear Nuevo Proveedor"><i class="fas fa-plus-circle fa-sm text-white-50"></i> Nuevo Proveedor</a>
        </div>
    </div>
    <div class="card-body">
