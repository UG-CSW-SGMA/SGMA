                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                @php $myseesion =Session('usuarioData')[0]@endphp
                                <img class="img-profile rounded-circle my-2" src="img/undraw_profile.svg">
                                <span class="ml-2 d-none d-lg-inline text-gray-600 small py-2"> <strong>{{$myseesion->NombreCompleto}}</strong></span>
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; CSW - SGMA 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
